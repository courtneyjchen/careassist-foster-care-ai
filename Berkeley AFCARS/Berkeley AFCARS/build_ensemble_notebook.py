#!/usr/bin/env python3
"""Generate the CareAssist Ensemble Colab notebook as valid .ipynb JSON."""
import json, os
...
for path in [
    r"c:\Users\Samantha Townsend\Downloads\CareAssist_Ensemble_Model.ipynb",
    r"c:\Users\Samantha Townsend\Downloads\Berkeley AFCARS\Berkeley AFCARS\CareAssist_Ensemble_Model.ipynb",
]:
...
with open(r"c:\Users\Samantha Townsend\Downloads\CareAssist_Ensemble_Model.ipynb", "r") as f:
    json.load(f)
print("\nJSON validation: OK")
