...
@Component({
  ...
  template: `
    <div class="foster-dash">
      ...
      <div class="children-grid stagger" *ngIf="children.length > 0">
        <div class="child-card animate-in" *ngFor="let child of children; let i = index"
  ...
  styles: [`
    ...
    .child-age { font-size: 12px; color: rgba(255,255,255,0.8); }
    ...
    .need-tag .material-icons-outlined { font-size: 13px; }
