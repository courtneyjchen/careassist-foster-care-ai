...
@Component({
  ...
  template: `
    <div class="supervisor-page">
      ...
      <div class="section-header animate-in">
        ...
        <span class="section-sub">{{ workers.length }} social workers</span>
      </div>

      <div class="worker-cards stagger">
        <div class="worker-card animate-in" *ngFor="let w of workers"
      ...
      <div class="checkin-grid stagger">
        <div class="checkin-card animate-in" *ngFor="let ci of checkIns"
  ...
  styles: [`
    ...
    .section-sub { font-size: 12px; color: var(--text-light); }
    ...
    .worker-name { font-size: 14px; font-weight: 700; display: block; }
    .worker-email { font-size: 11px; color: var(--text-light); }

    .worker-metrics { display: flex; gap: 20px; }
    .metric { text-align: center; }
    .metric-value { font-size: 18px; font-weight: 800; display: block; }
    .metric-label { font-size: 10px; color: var(--text-light); text-transform: uppercase; letter-spacing: 0.5px; }
    ...
    .case-num { font-weight: 600; font-family: var(--font-mono, monospace); font-size: 12px; }
    ...
    .flag-badge .material-icons-outlined { font-size: 14px; }
    ...
    .ci-day { font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; color: var(--text-light); display: block; }
    .ci-date { font-size: 16px; font-weight: 800; display: block; }

    .ci-info { flex: 1; }
    .ci-worker { font-size: 14px; font-weight: 700; display: block; }
    .ci-time {
      display: flex; align-items: center; gap: 4px;
      font-size: 12px; color: var(--text-light); margin-top: 2px;
    }
    .ci-time .material-icons-outlined { font-size: 14px; }
    .ci-topics { font-size: 11px; color: var(--text-secondary); margin-top: 3px; display: block; }
...
export class SupervisorDashboardComponent implements OnInit {
  ...
  buildCheckIns(): void {
    ...
    const workerNames = ['Samantha Townsend', 'Priya Patel', 'Marcus Williams'];
    const times = ['9:00 AM', '10:30 AM', '2:00 PM'];
    const topicSets = [
      'Caseload review, Maya J. placement update, court prep',
      'New case assignment, Sofia N. medical follow-up, training',
      'Noah L. behavioral plan, Zoe B. reunification timeline',
    ];
